...
pub const templates = struct {
  ...
  pub const example_with_partial = @import(".example_with_partial.zmpl.compiled.zig");
  pub const example_with_array_data_lookup = @import(".example_with_array_data_lookup.zmpl.compiled.zig");
  pub const example_with_multi_line_fragment_tag = @import(".example_with_multi_line_fragment_tag.zmpl.compiled.zig");
  ...
  pub const _example_partial = @import("._example_partial.zmpl.compiled.zig");
